#ifndef OPENGL_CORE_LIB_MONITOR_COLLECTION_REGISTRY_H_
#define OPENGL_CORE_LIB_MONITOR_COLLECTION_REGISTRY_H_
#include "opengl/core/lib/monitor/metric_def.h"
#include "opengl/core/lib/monitor/collected_metrics.h"
    ...
    namespace monitoring{
        ...
        class CollectionRegistry {
            ...
            private:
                ...
                void Unregister(const AbstractMetricDef* metric_def);
                ...
                std::map<string, CollectionInfo> registry_ ;

                DISALLOW_COPY_AND_ASSIGN(CollectionRegistry);
        };
        ...
        namespace internal{
            ...
            class Collector {
                ...
                private:
                    std::unique_ptr<CollectedMetrics> collected_metrics_;
